/*
    Tiene información de la vista de la pantalla principal "APP"
    la info esta en  toda en JSON
*/
...
const data = {
  menus: [
    ...
    { text: 'Work With', icon: <Web/>, link: '/workwith' },
    { text: 'Formularios', icon: <Web/>, link: '/formulario' },
    { text: 'EvoForms', icon: <Web/>, link: '/evoform' },
